...
int main() {
    ...
    (void)scaled; // exercising the interface while keeping reference values simple
    ...
    assert(decision.backend == clarabel::core::Backend::CPU); // threshold not met
